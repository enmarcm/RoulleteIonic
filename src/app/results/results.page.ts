...
export class ResultsPage implements OnInit, AfterViewInit {
  ...
  detectWinner() {
    ...
    const markCenterX = markWinner.getBoundingClientRect().left + markWinner.offsetWidth / 2;
    const markCenterY = markWinner.getBoundingClientRect().top + markWinner.offsetHeight / 2;
